...
public class NewTaskStateReceiver extends PushMessageReceiver {
    ...
    public void onReceiveRegisterResult(Context context, MiPushCommandMessage message) {
        ...
        if (MiPushClient.COMMAND_REGISTER.equals(command)) {
            if (message.getResultCode() == ErrorCode.SUCCESS) {
                ...
                mRegId = cmdArg1;
                Admin admin = Admin.fromSharedPreference(context);
                if (admin != null) {
                    String account = String.valueOf(admin.getUserId());
